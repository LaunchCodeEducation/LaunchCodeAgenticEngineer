...
```bash
cd module_2
docker build -t us-central1-docker.pkg.dev/hire-human/hire-human-ai/agentic_engineer_2:latest .
```
...
```bash
docker build \
  -t us-central1-docker.pkg.dev/hire-human/hire-human-ai/agentic_engineer_2:latest \
  -t us-central1-docker.pkg.dev/hire-human/hire-human-ai/agentic_engineer_2:2.0 .
```
...
```bash
docker push us-central1-docker.pkg.dev/hire-human/hire-human-ai/agentic_engineer_2:latest
docker push us-central1-docker.pkg.dev/hire-human/hire-human-ai/agentic_engineer_2:2.0
```
