...
- The DockerHub username/repository (default: `us-central1-docker.pkg.dev/hire-human/hire-human-ai/agentic_engineer_3`)
...
Steps:
1. Confirm the working directory contains a `Dockerfile`. If not, ask the user to navigate to the correct directory (e.g. `module_3/`).
...
6. On success, confirm the image is live and print the full image reference (e.g. `us-central1-docker.pkg.dev/hire-human/hire-human-ai/agentic_engineer_3:3.0`).
