...
- The DockerHub username/repository (default: `heatonresearch/agentic_engineer_3`)
...
6. On success, confirm the image is live and print the full image reference (e.g. `heatonresearch/agentic_engineer_3:3.0`).
